...
This code uses ggplot2 to generate a barplot to compare the top ten colleges that produced the most NBA players. ggplot2 is also used to produce a U.S. map to visualize the locations of the institutions that NBA players attended.
