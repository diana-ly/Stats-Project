...
# Then we made two empty data frame for roster and player_stats. We read the 
# CSV files from our github directories and added column 'Team' to each file by 
# usinig the team_names vector that we made above. 
roster <- data.frame()
...
# In each team stats CSV file, the last row of the file is "Team Totals", 
# which is not relevent to the player stats that we need in our project
